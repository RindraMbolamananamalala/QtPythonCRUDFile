...
class CrossPinningView(CRUDFileView):
    ...
    def update_buttons_availabilities(self):
        ...
        if not buttons_availabilities:
            ...
            button_confirm.setStyleSheet("background-color: #d9d9d9;")
    ...
    def update_content(self, line_to_display: LineToReadCrossPinning, current_lines_list_updated_length: int) -> None:
        """
