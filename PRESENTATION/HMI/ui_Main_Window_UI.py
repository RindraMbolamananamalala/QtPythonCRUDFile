...
class Ui_MainWindow(object):
    ...
    def __init__(self, main_window: QMainWindow):
        ...
        self.combo_box_open_connection_W.setGeometry(QRect(340, 200, 551, 121))
        font2 = QFont()
        ...
        self.text_open_connections_comments.setGeometry(QRect(900, 200, 361, 121))
        font3 = QFont()
        ...
        self.combo_box_shorts_W.setGeometry(QRect(510, 400, 551, 201))
        font7 = QFont()
        ...
        self.text_shorts_comments.setGeometry(QRect(1070, 400, 191, 201))
